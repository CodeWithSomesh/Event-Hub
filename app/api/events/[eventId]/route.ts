...
import { getEventById, updateEvent, deleteEvent, getAllEvents } from '@/lib/actions/event.actions';
...
// Update Event by Event ID that is retrieved in URL Params
...
// Delete Event by Event ID that is retrieved in URL Params
